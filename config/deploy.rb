...
namespace :deploy do
  ...
  namespace :delayed_job do
    ...
    task :restart, roles: :app, except: { no_release: true } do
      run "cd #{current_path}; RAILS_ENV=#{rails_env} sudo bundle exec script/delayed_job restart" rescue nil
    end
    desc 'Stop the delayed_job process'
    task :stop, roles: :app, except: { no_release: true } do
      run "cd #{current_path}; RAILS_ENV=#{rails_env} sudo bundle exec script/delayed_job stop" rescue nil
    end
  end
